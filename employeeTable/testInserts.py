...
def testInserts():
    ...
    entry = (str("%05d"%id),"Khaemon Edwards", "Denton",str("%04d"%pin))
    entry2 = (str("%05d"%id2)," Reynaldo Ferrari", "Denton", str("%04d"%pin2))
    entry3 = (str("%05d"%id3)," Ryan Vanek", "Denton", str("%04d"%pin3))
